...
data.wp_lib_ajax_nonce=params['wp_lib_ajax_nonce'];wp_lib_send_ajax(data,function(serverResponse){switch(serverResponse[0]){case 4:wp_lib_load_page();break;case 3:if(serverResponse[1][1].length===0){wp_lib_local_error('The action could not be completed but the server did not explain why');}
break;}});}
