...
notificationHolder.append(formattedNotification.element).hide().fadeIn(500);var displayTime=Math.min(Math.max(notificationText[1].length*150,3500),9000);setTimeout(function(){wp_lib_hide_notification(formattedNotification.element);},displayTime);}
